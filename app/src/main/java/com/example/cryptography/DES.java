...
public class DES extends AppCompatActivity {
    ...
    TextView tvresult,tvresult2,tvresult1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnencrypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    String enc = cipher.encrypt(plainText, Key);
                    tvresult1.setText("cipher_text = "+enc);
            ...
            class DES1 {
                ...
                String round(String input, String key, int num)
                {
                    ...
                    if (num==0){
                        tv3.setText("Round0"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==1){
                        tv4.setText("Round1"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==2){
                        tv5.setText("Round2"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==3){
                        tv6.setText("Round3"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==4){
                        tv7.setText("Round4"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==5){
                        tv8.setText("Round5"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==6){
                        tv9.setText("Round6"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==7){
                        tv10.setText("Round7"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==8){
                        tv11.setText("Round8"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==9){
                        tv12.setText("Round9"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==10){
                        tv13.setText("Round10"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==11){
                        tv14.setText("Round11"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==12){
                        tv15.setText("Round12"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==13){
                        tv16.setText("Round13"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==14){
                        tv17.setText("Round14"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                    if (num==15){
                        tv18.setText("Round15"+" "+ right.toUpperCase()+ " "+left.toUpperCase() + " "+ key.toUpperCase());}
                ...
                String encrypt(String plainText, String key)
                {
                    ...
                    tv1.setText("After initial permutation: "
                            + plainText.toUpperCase());
                    tv2.setText("After splitting: L0="
        ...
        btndecrypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    DES1 cipher = new DES1();
                    String dec = cipher.decrypt(plainText, Key);
                    tvresult1.setText("plain text = "+dec);
                    copy1.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                }
    ...
    {
        String text1 = tvresult1.getText().toString().trim();
